...
const questions = [
  { question: 'حسب التقریب في الأربعة جمعات لخرانیین قداش من مرة استعملت الفشفاشة الزرقة؟', options:['أكثر من 5 مرات في الجمعة', '4 او 5 مرات في الجمعة', '3 مرات في الجمعة ', 'مرتین في  الجمعة والا اقل', 'حتى مرة'] },
