...
const questions = [
  { question: 'إستعامل الفشفاشة الزرقة باش انحي العلامات هو أحسن حل باش نتحكم في الفدة', options:['موافق عالخر ', 'موافق', 'موش متأكد ', 'موش موافق', 'موش موافق بالكل'] },
  { question: 'منخافش مل الفدة يك تبدى الفشفاشة الزرقة معايا', options: ['موافق عالخر ', 'موافق', 'موش متأكد ', 'موش موافق', 'موش موافق بالكل'] },
  { question: 'الفشفاشة الزرقة هي الدواء الوحيد متاع الفدة الي انجم انعمل عليه', options: ['موافق عالخر ', 'موافق', 'موش متأكد ', 'موش موافق', 'موش موافق بالكل'] },
  { question: 'إستعامل الفشفاشة الزرقة الفايدة متاعها أكرث برشا من مشاكلها', options: ['موافق عالخر ', 'موافق', 'موش متأكد ', 'موش موافق', 'موش موافق بالكل'] },
  { question: 'انخري نعمل على الفشفاشة الزرقة خري مالفشفاشة متاع الوقاية متاع الكرتيكويد', options: ['موافق عالخر ', 'موافق', 'موش متأكد ', 'موش موافق', 'موش موافق بالكل'] },
];
...
const Stage1 = ({finish}) => {
  ...
  const finishQuestionnaire = () => {
    setConfirm(true);
    const sum = answers.reduce((accumulator, currentValue) => accumulator + currentValue, 5);
    finish(sum);
  };
